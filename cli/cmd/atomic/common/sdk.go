...
// the repo's early history contained a nested `github.com/ondrift/cloud/sdk/go`
...
// itself (v2+ is "github.com/ondrift/cloud/sdk/vN", not a bare version bump —
...
const DriftGoModule = "github.com/ondrift/cloud/sdk"
